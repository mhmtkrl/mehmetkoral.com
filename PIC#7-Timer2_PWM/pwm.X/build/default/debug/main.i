...
void main(void) {
    ...
    while(1) {
        for(duty_cycle = 1 ; duty_cycle < 1024 ; duty_cycle++) {
            CCPR1L = duty_cycle >> 2;
            CCP1CONbits.CCP1X = duty_cycle & 0x001;
            CCP1CONbits.CCP1Y = duty_cycle & 0x002;

            CCPR2L = (1023 - duty_cycle) >> 2;
            CCP2CONbits.CCP2X = (1023 - duty_cycle) & 0x001;
            CCP2CONbits.CCP2Y = (1023 - duty_cycle) & 0x002;
        ...
        for(duty_cycle = 1023 ; duty_cycle > 0 ; duty_cycle--) {
            ...
            CCPR2L = (1023 - duty_cycle) >> 2;
            CCP2CONbits.CCP2X = (1023 - duty_cycle) & 0x00;
            CCP2CONbits.CCP2Y = (1023 - duty_cycle) & 0x002;
            _delay((unsigned long)((1)*(20000000/4000.0)));
        }
    }
